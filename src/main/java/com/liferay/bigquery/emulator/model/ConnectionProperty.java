...
public class ConnectionProperty {
  ...
  @Schema(name = "key", description = "[Required] Name of the connection property to set.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("key")
  ...
  @Schema(name = "value", description = "[Required] Value of the connection property.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("value")

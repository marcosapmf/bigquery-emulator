...
import com.liferay.bigquery_emulator.model.ArimaCoefficients;
import com.liferay.bigquery_emulator.model.ArimaFittingMetrics;
...
@Schema(name = "ArimaModelInfo", description = "Arima model information.")
...
public class ArimaModelInfo {
   ...
   */
  @Valid 
  @Schema(name = "arimaCoefficients", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("arimaCoefficients")
